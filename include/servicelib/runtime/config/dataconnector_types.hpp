...
class DataConnectorConfigRef {
 public:
  using Variant =
      std::variant<std::reference_wrapper<const HttpDataConnectorConfig>,
 ...
 public:
  DataConnectorConfigRef(const HttpDataConnectorConfig& v)
      : value_(std::cref(v)) {}
  DataConnectorConfigRef(const GrpcDataConnectorConfig& v)
      : value_(std::cref(v)) {}
  DataConnectorConfigRef(const KafkaDataConnectorConfig& v)
      : value_(std::cref(v)) {}
  DataConnectorConfigRef(const CronDataConnectorConfig& v)
      : value_(std::cref(v)) {}
  DataConnectorConfigRef(const TemporalDataConnectorConfig& v)
      : value_(std::cref(v)) {}
  DataConnectorConfigRef(const CustomDataConnectorConfig& v)
      : value_(std::cref(v)) {}
...
inline HttpDataConnectorConfig Parse(
  ...
  result.implementation =
      value["implementation"].As<servicelib::api::DataConnectorImplementation>(
  ...
  detail::ParseRemainingProperties(value,
                                   {"id", "name", "implementation", "module",
                                    "host", "port", "useDedicatedListener"},
                                   result.properties);
  return result;
}
...
inline GrpcDataConnectorConfig Parse(
  ...
  result.programmingLanguage =
      value["programmingLanguage"].As<servicelib::api::ProgrammingLanguage>(
  ...
  if (result.connectionsCount < 1) {
    throw std::invalid_argument("gRPC connectionsCount must be at least 1");
  }
  detail::ParseRemainingProperties(
      value,
      {"id", "name", "implementation", "programmingLanguage", "module",
       "address", "connectionsCount"},
      result.properties);
  return result;
}
...
inline KafkaDataConnectorConfig Parse(
  ...
  result.securityProtocol =
      value["securityProtocol"].As<servicelib::api::KafkaSecurityProtocol>(
          servicelib::api::KafkaSecurityProtocol::kPLAINTEXT);
  result.saslMechanism =
      value["saslMechanism"].As<servicelib::api::KafkaSaslMechanism>(
  ...
  detail::ParseRemainingProperties(
      value,
      {"id", "name", "implementation", "programmingLanguage", "brokers",
       "version", "dialTimeout", "usePartitioner", "async", "securityProtocol",
...
inline CustomDataConnectorConfig Parse(
  ...
  result.implementation =
      value["implementation"].As<servicelib::api::DataConnectorImplementation>(
          servicelib::api::DataConnectorImplementation::kUndefined);
  detail::ParseRemainingProperties(value, {"id", "name", "implementation"},
                                   result.properties);
  return result;
}
...
inline CronDataConnectorConfig Parse(
    const userver::formats::yaml::Value& value,
    userver::formats::parse::To<CronDataConnectorConfig>) {
...
inline TemporalDataConnectorConfig Parse(
    const userver::formats::yaml::Value& value,
    userver::formats::parse::To<TemporalDataConnectorConfig>) {
